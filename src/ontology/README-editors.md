These notes are for the EDITORS of rubric
...
Make sure you have an ID range in the [idranges file](rubric-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [rubric-edit.owl](rubric-edit.owl)

** DO NOT EDIT rubric.obo OR rubric.owl in the top level directory **

[../../rubric.owl](../../rubric.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/cstansbu/data-use-ontology) for details.
 ...
 * [rubric-idranges.owl](rubric-idranges.owl)
...
This generates derived files such as rubric.owl and rubric.obo and places
 ...
 * https://github.com/cstansbu/data-use-ontology/releases
 * https://github.com/cstansbu/data-use-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived rubric.owl (`data-version` in
rubric.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/rubric.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/rubric/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/cstansbu/data-use-ontology.svg?branch=master)](https://travis-ci.org/cstansbu/data-use-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/cstansbu](https://travis-ci.org/profile/cstansbu)
 2. click the "Sync account" button
 3. Click the tick symbol next to data-use-ontology
